...
/*
	function createIFrame(eventData, callback) {
...
/*
		$tw.wiki.CommunicationsHandler['request_bundle'] = function(event) {
			var workerTiddler = $tw.wiki.getTiddler('$:/plugins/inmysocks/TWederation/WebWorker.js');
			...
			event.paramObject.wiki_type = "SINGLE_PAGE";
			$tw.wiki.communicationWorker.postMessage(event);
		}
*/
